...
app.use('/public/style', express.static(__dirname + '/public/style', { 'extensions': ['html', 'htm'], 'index': false, 'maxAge': '1d', 'setHeaders': function (res, path, stat) { res.set('Content-Type', 'text/css'); } }));
